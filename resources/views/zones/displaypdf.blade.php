    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header" style="padding-left: 900px">
                    <form action="/zones/search" method="get">
                        <div class="input-group">
                            <input type="search" name="search" class="form-control" placeholder="Search by zone name">
                        </div>
                    </form>
                </div>
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endif
                                @if ($zone->other == null)
                                    <td><em style="color: lightgrey">Not Avacilable</em></td>
                                @else
