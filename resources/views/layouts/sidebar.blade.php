...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="/images/rOCP_Group.png/images/rOCP_Group.png" />
        ...
        <div id="right-sidebar" class="settings-panel">
            ...
            <div class="tab-content" id="setting-content">
                <div class="tab-pane fade show active scroll-wrapper" id="todo-section" role="tabpanel" aria-labelledby="todo-section">
                    <h4 class="px-3 text-muted mt-5 font-weight-light mb-0">Notes</h4>
                    <!--Display all the description notes of reports with the corresponding date in here-->
                    @php
                        $reports = \App\Models\Reports::all();
                    @endphp
                    ...
                    <div class="events pt-4 px-3">
                        ...
                        <p class="mb-0 font-weight-thin text-gray">{{$report->notes}}</p>
                    </div>
                        @endif
                    @endforeach
                </div>
                <!-- bleso do section tab ends -->
